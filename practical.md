...
[Heap](https://github.com/emirpasic/gods/blob/master/trees/binaryheap/binaryheap.go)
[Priority Queue](https://github.com/emirpasic/gods/blob/master/queues/priorityqueue/priorityqueue.go)
[Dijkstra's Algorithm](https://github.com/arnauddri/algorithms/blob/master/algorithms/graphs/dijkstra/dijkstra.go)
...
2. To reinstate a good heap, a "bubble-up" operation is performed on the new node. The new node successively swaps with its parent if heap invariant does not hold and promotes until relation with a parent satisfies the heap invariant. 
...
Image Credits: http://web.stanford.edu/class/archive/cs/cs106b/cs106b.1176//assn/trailblazer.html
![pic](screenshot2.png)
